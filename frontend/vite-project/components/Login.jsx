const Login = () => {
    return (
        <div className="border-2 border-red-500 flex justify-center items-center min-h-screen bg-gray-100">
            <div className="border-2 border-blue-400 relative flex flex-col
            m-6 space-y-8 bg-white shadow-2xl rounded-2xl
            md:flex-row md:space-y-0">
                <div className="flex flex-col justify-center p-8 md:p-14">
                    <span className="mb-3 text-4xl font-bold">Login</span>
                    <span className="font-light text-gray-400 mb">Lorem ipsum! dolor sit amet consesour</span>
                    <div className="py-4">
                    ...
                    >
                        <img src="logo-google.svg" alt="logo-google" className="w-6 h-6 inline mr-2"/>
                        Sign in with Google
                    </button>
                ...
                <div className="relative">
                    ...
                    <div className="absolute hidden bottom-10 right-6 p-6 bg-white bg-opacity-30
                    backdrop-blur-sm rounded drop-shadow-lg md:block">
                        <span className="text-white text-xl">Colocar una imagen si es necesario para la version desktop</span>
                    </div>
                </div>
            </div>
        </div>
