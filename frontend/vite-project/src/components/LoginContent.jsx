    ...
    <div className="bg-white relative 
      ...
      >
        ...
        p-8 md:p-14">
          ...
          <span className="text-gray-400 font-light mb-8">Secure access to your account login.</span>
          <LoginInput title="email" inputType="text"/>
          <LoginInput title="password" inputType="password"/>
          <div className="flex justify-between w-full py-4">
            <div className="mr-10">
              <input type="checkbox" className="mr-2" name="chbox" id="chbox" />
              <span className="text-md">Remember for 24hs!</span>
            </div>
            <span className="text-md font-bold">Forgot Password</span>
          </div>
          ...
          <button className="border border-gray-300 w-full
